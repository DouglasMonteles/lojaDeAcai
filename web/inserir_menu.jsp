        ...
        <main>
            ...
            <div class="col s9 grey darken-4">
                <div class="row center-align card-panel grey darken-1white-text">
                      <h5 style="margin: 0 auto">Inserir Menu</h5>
                </div>
            ...
            <div class="row">
                <form class="col s12" action="gerenciar_menu.do" method="post">
                    ...
                    <div class="row">
                      ...
                      <div class="input-field col s6">
                          <input id="link" name="link" type="text" class="validate white-text" required>
                      ...
                      <div class="row">
                          <div class="input-field col s12">
                              <input id="icone" name="icone" type="text" class="validate white-text">
                              <label for="icone">Icone</label>
                            </div>
                      </div>

                      <div class="row right-align">
                            <button class="btn waves-effect waves-light" type="submit" name="action">Inserir Menu
